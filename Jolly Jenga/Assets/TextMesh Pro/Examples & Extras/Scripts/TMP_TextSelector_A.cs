  ...
  public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
  {
    ...
    private void LateUpdate()
    {
      ...
      #region Example of Character Selection
        ...
        var charIndex =
                TMP_TextUtilities.FindIntersectingCharacter(this.m_TextMeshPro, Input.mousePosition, Camera.main, true);
      ...
      #region Example of Word Selection
            ...
            wordIndex != this.m_lastWordIndex)
        {
          ...
          var wordPOS =
                  this.m_TextMeshPro.transform.TransformPoint(
                                                              this.m_TextMeshPro.textInfo
                                                                  .characterInfo[wInfo.firstCharacterIndex]
                                                                  .bottomLeft
                                                             );
