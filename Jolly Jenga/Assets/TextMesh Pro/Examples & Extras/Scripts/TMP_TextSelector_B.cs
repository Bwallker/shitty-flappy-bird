...
namespace TMPro.Examples
{
  public class TMP_TextSelector_B
          : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
  {
    ...
    private void Awake()
    {
      ...
      this.m_TextPopup_RectTransform = Object.Instantiate(this.TextPopup_Prefab_01);
    ...
    private void LateUpdate()
    {
      ...
      #region Word Selection Handling
        ...
        if (this.m_TextPopup_RectTransform != null &&
            this.m_selectedWord            != -1   &&
            (wordIndex == -1 || wordIndex != this.m_selectedWord))
        {
      ...
      #region Example of Link Handling
        ...
        if ((linkIndex == -1 && this.m_selectedLink != -1) ||
            ...
            linkIndex != this.m_selectedLink)
        {
          ...
          RectTransformUtility.ScreenPointToWorldPointInRectangle(
                                                                  this.m_TextMeshPro.rectTransform,
                                                                  Input.mousePosition,
                                                                  this.m_Camera,
          ...
          switch (linkInfo.GetLinkID())
          {
            case "id_01": // 100041637: // id_01
              ...
              this.m_TextPopup_TMPComponent.text = TMP_TextSelector_B.k_LinkText + " ID 01";
            ...
            case "id_02": // 100041638: // id_02
              this.m_TextPopup_RectTransform.position = worldPointInRectangle;
              this.m_TextPopup_RectTransform.gameObject.SetActive(true);
              this.m_TextPopup_TMPComponent.text = TMP_TextSelector_B.k_LinkText + " ID 02";
    ...
    {
      if (index == -1 ||
          index > this.m_TextMeshPro.textInfo.characterCount - 1)
      {
        return;
      }
