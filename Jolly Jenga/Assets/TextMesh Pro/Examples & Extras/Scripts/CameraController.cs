...
namespace TMPro.Examples
{
  public class CameraController : MonoBehaviour
  {
      ...
      if (this.CameraTarget != null)
      {
        ...
        if (this.MovementSmoothing)
        {
          ...
          this.cameraTransform.position = Vector3.SmoothDamp(
                                                             ...
                                                             this.MovementSmoothingValue * Time.fixedDeltaTime
                                                            );
        ...
        if (this.RotationSmoothing)
        {
          this.cameraTransform.rotation = Quaternion.Lerp(
                                                          ...
                                                          Quaternion.LookRotation(
                                                             this.CameraTarget.position - this.cameraTransform.position
                                                            ),
    ...
    private void GetPlayerInput()
    {
      ...
      if (this.mouseWheel < -0.01f ||
          this.mouseWheel > 0.01f)
      {
