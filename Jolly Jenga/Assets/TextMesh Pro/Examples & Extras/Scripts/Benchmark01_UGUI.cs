  ...
  public class Benchmark01_UGUI : MonoBehaviour
  {
    ...
    private IEnumerator Start()
    {
      ...
      for (var i = 0; i <= 1000000; i++)
      {
        ...
        {
          this.m_textMeshPro.text = Benchmark01_UGUI.label01 + (i % 1000);

          if (i % 1000 == 999)
          {
            this.m_textMeshPro.fontSharedMaterial = this.m_textMeshPro.fontSharedMaterial == this.m_material01
                                                            ? this.m_textMeshPro.fontSharedMaterial = this.m_material02
                                                            : this.m_textMeshPro.fontSharedMaterial = this.m_material01;
          }
        }
        else if (this.BenchmarkType == 1)
        {
          this.m_textMesh.text = Benchmark01_UGUI.label02 + (i % 1000);
        }
