  ...
  #pragma warning disable 0414
    ...
    private void Update()
    {
      ...
      else if (this.Motion == MotionType.BackAndForth)
      {
        ...
        this.m_transform.rotation = Quaternion.Euler(
                                                     this.m_initial_Rotation.x,
                                                     (Mathf.Sin(this.m_time) * this.RotationRange) +
                                                     this.m_initial_Rotation.y,
                                                     this.m_initial_Rotation.z
                                                    );
      }
      else
      {
